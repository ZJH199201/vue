...
["get", "post", "put", "delete"].forEach(method => {
    http[method] = (
        ...
        if (process.env.NODE_ENV == "development") {
            // 测试接口
            //庞世锋
            if (typs == 119) action = "http://172.16.21.122/notice" + action;
            
            //章国华
            if (typs == 120) action = "http://172.16.21.121:8888/equipment-center-admin" + action;
            
            //苏东染
            if (typs == 117) action = "http://172.16.21.121:8888/equipment-center-admin" + action;

            //张建华
<<<<<<< HEAD
            if (typs == 121) action = "http://172.16.21.121:8888/equipment-center-expert" + action;

=======
            if (typs == 121) action = "http://172.16.64.55:8092" + action;
            // if (typs == 121) action = "http://172.16.21.121:8888/equipment-center-expert" + action;
>>>>>>> 专家端对接接口
